...
When I’ve built MVPs at places like **Affirm** and **Ramp**, here’s what consistently worked:
...
At **Ramp**, I once shipped a backend service + frontend flow + API integration in under two weeks for a new payment workflow. It was hacky. It had no tests (yet). But it got real users on a new feature path that later justified a much larger investment.
