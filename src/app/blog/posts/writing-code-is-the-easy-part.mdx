...
But after working at multiple projects at **Affirm** and **Ramp**—I can confidently say this:
...
<Carousel
  images={[{ src: "/images/blog/startups-writing-code-is-the-easy-part/3.jpg", alt: "Post-it wall of changing priorities and checkmarks" }]}
/>
...
At Ramp, I was moving fast—AI workflows, SDKs, pipeline design. The code was real, but the real challenge was:
